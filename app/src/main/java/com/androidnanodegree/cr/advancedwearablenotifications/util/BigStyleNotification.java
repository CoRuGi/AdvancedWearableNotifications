...
public class BigStyleNotification {
    /**
    ...
    public BigStyleNotification(Context context){
        mContext = context;
    }
    ...
    public void show(){
         ...
         *    anything vital!
         */
        builder.setContentTitle(mContext.getString(R.string.big_style_notification_title));
        builder.setContentText(mContext.getString(R.string.big_style_notification_text));
        builder.setSubText(mContext.getString(R.string.big_style_notification_sub_text));

        /**
         * Here we specify the BigTextStyle to provide a larger area inside the notification to
         * show the information
         */
        NotificationCompat.BigTextStyle bigTextStyle = new NotificationCompat.BigTextStyle();
        bigTextStyle.bigText(mContext.getString(R.string.big_style_notification_large_text));

        /**
         * Now we set the style to the NotificationCompat.Builder
         */
